    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>I'm <span>Jenny Wilson</span> a Professional Henna Designer from Taxila</h2>
          <p>"Infusing passion and precision into every design, I craft henna art that speaks volumes, blending tradition with innovation. Let your skin be the canvas for my creativity, where each stroke reflects not just skill, but a story waiting to be told."</p>
